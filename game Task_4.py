...
class RockPaperScissorsGame:
    def __init__(self, root):
        ...
        self.root.geometry("400x300")  # Increase the size
        ...
        self.result_label = tk.Label(root, text="", font=("Helvetica", 16))  # Increase the font size
    ...
    def play(self):
        ...
        self.result_label.config(text=result, fg=color)  # Set the text color
